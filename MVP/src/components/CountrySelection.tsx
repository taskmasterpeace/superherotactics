        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          >
            ...
            <div className="mt-4 flex flex-wrap gap-2">
              ...
              {['United States', 'India', 'China', 'Nigeria', 'Japan', 'Germany', 'Brazil'].map(name => {
                ...
                return (
                  <button
                    key={name}
                    onClick={() => handleSelectCountry(country)}
                    className="px-3 py-1 text-sm bg-gray-700 hover:bg-gray-600 rounded-full flex items-center gap-1 transition-colors"
                  >
                    {country.flag} {name}
                  </button>
                )
