...
function getWeaponEmoji(name: string): string {
  ...
  if (name.toLowerCase().includes('pistol')) return '🔫';
  if (name.toLowerCase().includes('rifle')) return '🎯';
  if (name.toLowerCase().includes('shotgun')) return '💥';
  if (name.toLowerCase().includes('knife') || name.toLowerCase().includes('blade')) return '🔪';
  if (name.toLowerCase().includes('grenade')) return '💣';
  if (name.toLowerCase().includes('laser') || name.toLowerCase().includes('energy')) return '⚡';
